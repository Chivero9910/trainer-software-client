...
import { addMetricsService, deleteMetricService, getMetricsDetailsService, updateMetricsService } from "../services/profile.services.js";
...
function ModalEditMetric(props) {
  ...
  const handleupdateMetrics = async (e) => {
    ...
    try {
        await updateMetricsService(addMetrics, props.id)
        setOpen(false)
        props.dataMetricas()
    } catch (error) {
        console.log(error)
...
const handleDeleteMetric = async () => {
        try {
            await deleteMetricService(props.id)
            setOpen(false)
            props.dataMetricas()
        } catch (error) {
            console.log(error)
...
const getData = async() => {
    try {
        const response = await getMetricsDetailsService(props.id)
        setPesoCorporal(response.data.pesoCorporal)
        setGrasaCorporal(response.data.grasaCorporal)
        setCuello(response.data.cuello)
        setHombros(response.data.hombros)
        setPecho(response.data.pecho)
        setBicepsIzq(response.data.bicepsIzq)
        setBicepsDer(response.data.bicepsDer)
        setAnteBrazoIzq(response.data.anteBrazoIzq)
        setAnteBrazoDer(response.data.anteBrazoDer)
        setCintura(response.data.cintura)
        setCadera(response.data.cadera)
        setMusloIzq(response.data.musloIzq)
        setMusloDer(response.data.musloDer)
        setGemeloIzq(response.data.gemeloIzq)
        setGemeloDer(response.data.gemeloDer)
